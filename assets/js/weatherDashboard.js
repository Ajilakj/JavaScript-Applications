        ...
        .then(function (dataSet) {
          ...
          for (var i = 0; i <= dataSet.cnt; i += 9) {
            ...
            document.getElementById("temp" + c).textContent =
              dataSet.list[i].main.temp + " F";
            document.getElementById("wind" + c).textContent =
              dataSet.list[i].wind.speed + " MPH";
            document.getElementById("humidity" + c).textContent =
              dataSet.list[i].main.humidity + " %";
            c++;
          }
        });
    });
